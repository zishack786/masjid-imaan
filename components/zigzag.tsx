        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">
              Don't Miss This Opportunity To Learn From An Alim!
            </h1>
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">
              Narrated 'Abdullah bin 'Amr bin Al-'As:
            </div>
            <p className="text-xl text-gray-400">
              that the Messenger of Allah (ﷺ) said: "Indeed Allah does not take
              away knowledge by removing it from the people, but He takes away
              knowledge by taking the scholars, until there remains no scholar
              and the people begin to ask the ignorant leaders, so they give
              their verdict without knowledge. They will go astray and lead the
              people astray."
            </p>
          </div>
          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h3 mb-3">Jumu'ah Salah Timings</h3>
                  <p className="text-xl text-gray-400 mb-4">
                    O believers! When the call to prayer is made on Friday, then
                    proceed ˹diligently˺ to the remembrance of Allah and leave
                    off ˹your˺ business. That is best for you, if only you
                    knew.Once the prayer is over, disperse throughout the land
                    and seek the bounty of Allah. And remember Allah often so
                ...
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Multiple Excecise Machines</span>
                    </li>
                    <li className="flex items-center">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                ...
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Children have a playroom with toys</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  <div className="font-architects-daughter text-xl text-purple-600 mb-2">
                    Pray Eid Al Fitr Salah locally
                  </div>
                  <h3 className="h3 mb-3">
